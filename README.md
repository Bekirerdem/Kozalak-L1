...
| 3   | **ICTT Cross-L1 Köprü**          | ✅ v0.3.1      | `ava-labs/icm-contracts` audited inherit — Token Home ([Fuji C-Chain](https://testnet.snowtrace.io/address/0x2b1377537690793939DC42530c15DA897AC9D2D9)) + Token Remote (Fuji L1). **Uçtan uca doğrulandı:** KGAS lock → relayer → wKGAS mint ([kanıt](docs/tr/03-templateler/ictt-demo-kanit.md)), tek komutla tekrarlanabilir (`scripts/demo/run-ictt-demo.sh`) |
